	...
	<section class="">
		<header class="app-header back-lightgray flex flex-middle flex-between" >
			<article class="flex flex-middle">
				<div class="color-white margin-right15" style="font-size: 45px;border-right:1px solid lightgray; padding-right:20px">
			...
			<article>
				<figure class="margin0" style="width:130px">
					<img class="width100" src="http://tya-register.dev/assets/app/img/unexpect_blue.png" alt="">
				</figure>
			</article>
		</header>
